                ...
                <div class="col-md-6 col-lg-12 grid-margin stretch-card">
                    <div class="card bg-gradient-primary card-rounded ">
                        <div class="card-body pb-0">
                            <h4 class="card-title card-title-dash text-white mb-4">Blog Count</h4>
                            <div class="row">
                                <div class="col-sm-4">
                                    <p class="status-summary-ight-white mb-1">Total Blog Count</p>
                                    <h2 class="text-info mb-5">{{$blog}}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
