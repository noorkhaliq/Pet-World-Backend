...
Route::get('section/{slug}', [\App\Http\Controllers\FrontendController::class, 'about'])->name('front.about');
...
Route::get('front/blog', [\App\Http\Controllers\FrontendController::class, 'blog'])->name('front.blog');
Route::get('blog/{slug}', [\App\Http\Controllers\FrontendController::class, 'blogDetail'])->name('front.blog.detail');
Route::get('front/services', [\App\Http\Controllers\FrontendController::class, 'services'])->name('front.services');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/admin', [App\Http\Controllers\UserController::class, 'dash'])->name('dashboard');
